            ...
            <section>
                <div className="bg-white py-10">
                    ...
                    <div className="text-center mt-8">
                        <button className="bg-white text-violet-500 hover:text-violet-600 active:text-violet-700 focus:outline-none focus:ring focus:ring-violet-300 px-6 py-2 rounded-full">Show more</button>
                    </div>
                </div>
            </section>
            <section>
                <div className="bg-gray-100 py-10 px-10">
                    <div className="text-center font-bold text-4xl mb-16">How Studypal works:</div>
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-12 text-center px-4 md:px-0">
                        ...
                        <div className="flex flex-col items-center bg-white rounded-lg shadow-lg transform hover:-translate-y-2 transition duration-300">
                            <div className="rounded-full h-16 w-16 flex items-center justify-center bg-green-500 text-white text-2xl font-bold mb-4 mt-6">1</div>
                        ...
                        {/* Step 2 */}
                        <div className="flex flex-col items-center bg-white rounded-lg shadow-lg transform hover:-translate-y-2 transition duration-300">
                            <div className="rounded-full h-16 w-16 flex items-center justify-center bg-yellow-500 text-white text-2xl font-bold mb-4 mt-6">2</div>
                        ...
                        {/* Step 3 */}
                        <div className="flex flex-col items-center bg-white rounded-lg shadow-lg transform hover:-translate-y-2 transition duration-300">
                            <div className="rounded-full h-16 w-16 flex items-center justify-center bg-blue-500 text-white text-2xl font-bold mb-4 mt-6">3</div>
            ...
            <section>
                <div className="w-10/12 flex items-center bg-teal-600 text-white p-10 mx-auto rounded-lg shadow-xl">
                    ...
                    <div className="w-7/12 pl-10 pr-20">
                        ...
                        <a href="#" className="text-sm text-teal-200 underline hover:text-teal-100 mt-4 inline-block transition-colors duration-300 ease-in-out">
