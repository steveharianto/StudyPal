  ...
  const recommendedTutors = [
    {
      ...
      subject: "Mathematics",
      price: "$40/hour",
      imageUrl: 'https://thefutureispublictransport.org/wp-content/uploads/2022/09/Story-C40-SiteImage_04.jpg',
    },
    {
      name: "Ms. Davis",
      subject: "Physics",
      price: "$35/hour",
      imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/9/9f/Megawati_Sukarnoputri_official_portrait.jpg/735px-Megawati_Sukarnoputri_official_portrait.jpg',
    },
    {
      name: "Dr. Thompson",
      subject: "Chemistry",
      price: "$45/hour",
      imageUrl: 'https://asset.kompas.com/crops/A0qds-2BjWmU4g8xkkxJANW0Zmo=/0x0:0x0/750x500/data/photo/2022/10/24/635673c468c46.jpg',
    },
      ...
      <main className="max-w-7xl mx-auto px-5 py-12 bg-gray-100">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {recommendedTutors.map((tutor, index) => (
              <div key={index} className="bg-white p-6 shadow-md rounded-lg hover:shadow-2xl transition-shadow duration-300 ease-in-out">
                <img src={tutor.imageUrl} alt={`Image of ${tutor.name}`} className="w-full h-60 object-cover rounded-lg mb-4" />
                <h4 className="font-semibold text-lg text-green-600 mb-2">{tutor.name}</h4>
              ...
              {recentMessages.map((message, index) => (
                <div key={index} className="bg-gradient-to-r from-blue-200 to-indigo-200 p-6 shadow-md rounded-lg hover:shadow-2xl transition-shadow duration-300 ease-in-out">
                  <p className="text-gray-800 font-semibold">
                    {message.sender} - <span className="text-gray-700">{message.date}</span>
                  </p>
        ...
        <section className="text-center">
          ...
          <div className="flex justify-center flex-wrap gap-4">
            <a href="#" className="bg-gradient-to-r from-green-400 to-blue-500 text-white px-6 py-3 rounded-lg hover:bg-gradient-to-l transition-colors duration-300 ease-in-out">Link 1</a>
            <a href="#" className="bg-gradient-to-r from-pink-500 to-orange-400 text-white px-6 py-3 rounded-lg hover:bg-gradient-to-l transition-colors duration-300 ease-in-out">Link 2</a>
